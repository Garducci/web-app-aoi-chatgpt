                ...
                <Stack horizontal className={styles.chatRoot}>
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    src={norteenergia-black}
                                    className={styles.chatIcon}
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Começar a conversar</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Este chatbot está configurado para responder às suas perguntas</h2>
                            </Stack>
                        ) : (
                        ...
                        <Stack horizontal className={styles.chatInput}>
                            ...
                            <QuestionInput
                                clearOnSend
                                placeholder="Começar a conversar..."
                                disabled={isLoading}
                                onSend={(question, id) => {
